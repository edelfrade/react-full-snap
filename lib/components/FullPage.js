  ...
  function FullPage(props) {
    ...
    _this.setHeights = function () {
      if (!_this.scrollPending) {
        _this.setState({ height: window.innerHeight - _this.props.offset });
      } else {
        setTimeout(function () {
          _this.setHeights();
        }, 90);
  ...
  _createClass(FullPage, [{
    ...
    value: function scrollToSlide(slide) {
      ...
      if (!this.scrollPending && slide >= 0 && slide < this.slidesCount) {
        ...
        (0, _animatedScrollTo2.default)((window.innerHeight - this.props.offset) * slide, this.props.duration, this.myRef, this.props.windowScroll, function () {
